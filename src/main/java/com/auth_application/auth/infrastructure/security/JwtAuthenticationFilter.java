...
import com.auth_application.shared.infrastructure.controllers.GetTokenFromRequest;
...
//            ApiResponseHelper.sendErrorResponse(response, HttpStatus.BAD_REQUEST, "Bad Request", "El token no puede ser nulo");
        ...
        UserAuth userReadModel = authServices.decode(TokenUserResponse.builder().token(token).build());
